      ...
      body: (
        <div>
          ...
          <ol>
            ...
            <li>Jugar cartas consume Stamina y produce efectos (daño o curación).</li>
            <li>Cuando la Salud del enemigo llega a 0, lo derrotas y avanzas en el mapa.</li>
    ...
    <footer className={styles.footerWrap}>
      <div className={styles.container}>
        ...
        <div className={styles.actions}>
          <Button onClick={openRules} variant="ghost" ariaLabel="Info">Info</Button>
        </div>
      </div>
    </footer>
  );
